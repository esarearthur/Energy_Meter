...
class TinyGsmSim800 : public TinyGsmModem<TinyGsmSim800>,
    ...
    class GsmClientSim800 : public GsmClient {
       ...
       public:
        virtual int connect(const char* host, uint16_t port, int timeout_s) {
            ...
            rx.clear();
            sock_connected =
                at->modemConnect(host, port, mux, false, timeout_s);
   ...
   protected:
    ...
    size_t modemRead(size_t size, uint8_t mux) {
        ...
        // SRGD NOTE:  Contrary to above (which is copied from AT command
        // manual) this is actually be the number of bytes that will be
        // remaining in the buffer after the read.
        ...
        do {
            ...
            while (stream.available() > 0) {
                ...
                if (r1 && data.endsWith(r1)) {
                    ...
                    streamSkipUntil('\n');  // Refresh Network Daylight Saving
                                            // Time by network
                    data = "";
